...
void test_kiln_string_trim_inplace() {
    ...
    kiln_string_t leading = KilnString_from_cstr("   Hello World");
    ...
    kiln_string_t trailing = KilnString_from_cstr("Hello World   ");
    ...
    kiln_string_t both = KilnString_from_cstr("  Hello World  ");
    ...
    kiln_string_t only_space = KilnString_from_cstr("     ");
    ...
    kiln_string_t no_space = KilnString_from_cstr("Hello");
    ...
    kiln_string_t various = KilnString_from_cstr("\t\n\r Hello World \t\n\r");
...
void test_stringref_trim() {
    // Test with leading whitespace
    kstring_ref_t leading = StringRef_from_cstr("   Hello World");
    kstring_ref_t trimmed_leading = StringRef_trim(leading);
    assert(trimmed_leading.__length == 11);
    // Can't use strcmp directly with StringRef, so create a kiln_string_t for comparison
    kiln_string_t kstr_leading = StringRef_to_kiln_string(trimmed_leading);
    assert(strcmp(kstr_leading.ptr, "Hello World") == 0);
    KilnString_free(&kstr_leading);
    
    // Test with trailing whitespace
    kstring_ref_t trailing = StringRef_from_cstr("Hello World   ");
    kstring_ref_t trimmed_trailing = StringRef_trim(trailing);
    assert(trimmed_trailing.__length == 11);
    kiln_string_t kstr_trailing = StringRef_to_kiln_string(trimmed_trailing);
    assert(strcmp(kstr_trailing.ptr, "Hello World") == 0);
    KilnString_free(&kstr_trailing);
    
    // Test with both leading and trailing whitespace
    kstring_ref_t both = StringRef_from_cstr("  Hello World  ");
    kstring_ref_t trimmed_both = StringRef_trim(both);
    assert(trimmed_both.__length == 11);
    kiln_string_t kstr_both = StringRef_to_kiln_string(trimmed_both);
    assert(strcmp(kstr_both.ptr, "Hello World") == 0);
    KilnString_free(&kstr_both);
    
    // Test with only whitespace
    kstring_ref_t only_space = StringRef_from_cstr("     ");
    kstring_ref_t trimmed_only_space = StringRef_trim(only_space);
    assert(trimmed_only_space.__length == 0);
    kiln_string_t kstr_only_space = StringRef_to_kiln_string(trimmed_only_space);
    assert(strcmp(kstr_only_space.ptr, "") == 0);
    KilnString_free(&kstr_only_space);
    
    // Test with empty string
    kstring_ref_t empty = StringRef_from_cstr("");
    kstring_ref_t trimmed_empty = StringRef_trim(empty);
    assert(trimmed_empty.__length == 0);
    
    // Test with no whitespace (should remain unchanged)
    kstring_ref_t no_space = StringRef_from_cstr("Hello");
    kstring_ref_t trimmed_no_space = StringRef_trim(no_space);
    assert(trimmed_no_space.__length == 5);
    kiln_string_t kstr_no_space = StringRef_to_kiln_string(trimmed_no_space);
    assert(strcmp(kstr_no_space.ptr, "Hello") == 0);
    KilnString_free(&kstr_no_space);
    
    // Test with various whitespace characters
    kstring_ref_t various = StringRef_from_cstr("\t\n\r Hello World \t\n\r");
    kstring_ref_t trimmed_various = StringRef_trim(various);
    assert(trimmed_various.__length == 11);
    kiln_string_t kstr_various = StringRef_to_kiln_string(trimmed_various);
...
void test_kilnstring_trim() {
    // Test with leading whitespace
    kiln_string_t leading = KilnString_from_cstr("   Hello World");
    kstring_ref_t trimmed_leading = KilnString_trim(&leading);
    assert(trimmed_leading.__length == 11);
    kiln_string_t kstr_leading = StringRef_to_kiln_string(trimmed_leading);
    assert(strcmp(kstr_leading.ptr, "Hello World") == 0);
    KilnString_free(&leading);
    ...
    // Test with trailing whitespace
    kiln_string_t trailing = KilnString_from_cstr("Hello World   ");
    kstring_ref_t trimmed_trailing = KilnString_trim(&trailing);
    assert(trimmed_trailing.__length == 11);
    kiln_string_t kstr_trailing = StringRef_to_kiln_string(trimmed_trailing);
    assert(strcmp(kstr_trailing.ptr, "Hello World") == 0);
    KilnString_free(&trailing);
    ...
    // Test with both leading and trailing whitespace
    kiln_string_t both = KilnString_from_cstr("  Hello World  ");
    kstring_ref_t trimmed_both = KilnString_trim(&both);
    assert(trimmed_both.__length == 11);
    kiln_string_t kstr_both = StringRef_to_kiln_string(trimmed_both);
    assert(strcmp(kstr_both.ptr, "Hello World") == 0);
    KilnString_free(&both);
    ...
    // Test with only whitespace
    kiln_string_t only_space = KilnString_from_cstr("     ");
    kstring_ref_t trimmed_only_space = KilnString_trim(&only_space);
    assert(trimmed_only_space.__length == 0);
    KilnString_free(&only_space);
}
...
void test_kilnstring_replace() {
    ...
    kiln_string_t basic = KilnString_from_cstr("Hello, world!");
    ...
    kiln_string_t shorter = KilnString_from_cstr("Replace longer with short");
    ...
    kiln_string_t longer = KilnString_from_cstr("Make this bigger");
    ...
    kiln_string_t not_found = KilnString_from_cstr("Nothing to replace here");
    ...
    kiln_string_t delete_target = KilnString_from_cstr("Remove this word");
    ...
    kiln_string_t empty_target = KilnString_from_cstr("Don't change me");
    ...
    kiln_string_t multiple = KilnString_from_cstr("one two one two one");
    ...
    kiln_string_t at_beginning = KilnString_from_cstr("Start with this");
    ...
    kiln_string_t at_end = KilnString_from_cstr("This is the end");
    ...
    kiln_string_t same = KilnString_from_cstr("No real change");
    ...
    kiln_string_t case_sensitive = KilnString_from_cstr("Case CASE case");
...
void test_combined_operations() {
    ...
    kiln_string_t trim_then_replace = KilnString_from_cstr("  Hello, world!  ");
    ...
    kiln_string_t replace_then_trim = KilnString_from_cstr("  Old text here  ");
    ...
    kiln_string_t multiple_ops = KilnString_from_cstr("\t Complex example with SPACES \n");
