...
/// @param str_ref 
/// @return 
inline kiln_string_t KilnString_from_string_ref(kstring_ref_t str_ref) {
	kiln_string_t str = {
...
/// @param str_ref 
/// @return 
inline kiln_string_t StringRef_to_kiln_string(kstring_ref_t str_ref) {
	return KilnString_from_string_ref(str_ref);
}

inline kstring_ref_t KilnString_as_stringref(const kiln_string_t* string) {
	kstring_ref_t ref;
...
inline kstring_ref_t StringRef_from_kiln_str(const kiln_string_t* string) {
	return KilnString_as_stringref(string);
}

inline kstring_ref_t StringRef_from_cstr(const char* string) {
	kstring_ref_t ref;
...
/// @param str 
/// @return 
inline void KilnString_free(kiln_string_t* str) {
	free(str->ptr);
	str->ptr = NULL;
}
...
/// @param string 
/// @param cstr 
inline void KilnString_push_cstr(kiln_string_t* string, const char* cstr) {
...
/// @param end_idx -1 to default to the end
/// @return A kstring_ref_t pointing to the requested substring
inline kstring_ref_t KilnString_substring(const kiln_string_t* string, int64_t start_idx, int64_t end_idx) {
...
inline bool StringRef_equals_cstr(kstring_ref_t string, const char* other) {
...
/// @return true if the strings are equal, false otherwise
inline bool StringRef_equals(kstring_ref_t s1, kstring_ref_t s2) {    
...
/// @param other The C-style string to compare against
/// @return true if the strings are equal, false otherwise
inline bool KilnString_equals_cstr(const kiln_string_t* string, const char* other) {
    kstring_ref_t ref = {string->ptr, string->__length};
...
/// @return true if the strings are equal, false otherwise
inline bool KilnString_equals(const kiln_string_t* s1, const kiln_string_t* s2) {
...
/// @return 0 if equal, negative if s1 < s2, positive if s1 > s2
inline int32_t KilnString_compare(const kiln_string_t* s1, const kiln_string_t* s2) {
...
/// @param target The substring to find
/// @return Returns `-1` if target is not in `string`
inline int64_t KilnString_find(const kiln_string_t* string, const char* target) {
    kstring_ref_t ref = {string->ptr, string->__length};
...
/// @param target The substring to find
/// @return Returns `-1` if target is not in `string`
inline int64_t KilnString_rfind(const kiln_string_t* string, const char* target) {
    kstring_ref_t ref = {string->ptr, string->__length};
...
/// @param delimiter The delimiter string to search for
/// @param output_buffer Array of 2 StringRefs to store the results - first part before delimiter, second part after delimiter
inline void KilnString_partition(const kiln_string_t* string, const char* delimiter, kstring_ref_t output_buffer[2]) {
    kstring_ref_t ref = {string->ptr, string->__length};
...
/// @param delimiter The delimiter string to search for from the end
/// @param output_buffer Array of 2 StringRefs to store the results - first part before last delimiter, second part after last delimiter
inline void KilnString_rpartition(const kiln_string_t* string, const char* delimiter, kstring_ref_t output_buffer[2]) {
    kstring_ref_t ref = {string->ptr, string->__length};
